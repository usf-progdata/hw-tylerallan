...
thesisdatam <- thesisdata %>%
  ...
  mutate(
    # WDG: Look into using functions like `starts_with()` or `contains()` to make this clearer and easier
    I_tot = mean(c(
      pgi_01_I, pgi_02_I, pgi_03_I, pgi_04_I, pgi_05_I, pgi_06_I, pgi_07_I, pgi_08_I, pgi_09_I, pgi_10_I, pgi_11_I, pgi_12_I, pgi_13_I, pgi_14_I,
      ...
      pgi_29_I, pgi_30_I, pgi_31_I, pgi_32_I, pgi_33_I, pgi_34_I, pgi_35_I, pgi_36_I, pgi_37_I, pgi_38_I, pgi_39_I, pgi_40_I
    ), na.rm = TRUE),
    C_tot = mean(c(
      pgi_01_c, pgi_02_c, pgi_03_c, pgi_04_c, pgi_05_c, pgi_06_c, pgi_07_c, pgi_08_c, pgi_09_c, pgi_10_c, pgi_11_c, pgi_12_c, pgi_13_c, pgi_14_c,
      ...
      pgi_29_c, pgi_30_c, pgi_31_c, pgi_32_c, pgi_33_c, pgi_34_c, pgi_35_c, pgi_36_c, pgi_37_c, pgi_38_c, pgi_39_c, pgi_40_c
    ), na.rm = TRUE),
    PCI_tot = mean(c(
      pci_01, pci_02, pci_03, pci_04, pci_05, pci_06, pci_07, pci_08, pci_09, pci_10, pci_11, pci_12, pci_13, pci_14, pci_15, pci_16, pci_17, pci_18,
      ...
      pci_37, pci_38, pci_39, pci_40, pci_41, pci_42
    ), na.rm = TRUE)
  ) %>%
  summarize(across(
    c(I_tot:PCI_tot),
...
# x argument is missing, with no default
# i Input `..1` is `(function (.cols = everything(), .fns = NULL, ..., .names = NULL) ...`.
  
# Make sure it's able to run on a fresh R session/ is correct.
...
# WDG: We have to write (write.csv()) things too.
