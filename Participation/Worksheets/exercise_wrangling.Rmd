...
# Do it shorter with `:` :
select(gapminder, c(country:lifeExp))
```
...
gapminder %>%
  mutate(grossGDP = gdpPercap*pop,
         gdpBill = grossGDP/100, 
         signif(gdpBill, digits = 3))
...
```{r}
gapminder %>%
  mutate(lifeExp = if_else(country == "Canada" & year == 1952, true = 70, false = lifeExp))
